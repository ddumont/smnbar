return {
  { texture = nil, ptr = nil, action = nil, name = 'carbuncle', commands = {
    ...
    { texture = nil, ptr = nil, action = nil, command = 'shining ruby',     target = '<stpc>',  ranks = 1 },
    { texture = nil, ptr = nil, action = nil, command = 'glittering ruby',  target = '<stpc>',  ranks = 1 },
    { texture = nil, ptr = nil, action = nil, command = 'soothing ruby',    target = '<stpc>',  ranks = 1 },
    { texture = nil, ptr = nil, action = nil, command = 'pacifying ruby',   target = '<stpc>',  ranks = 1 },
  } },
  ...
  { texture = nil, ptr = nil, action = nil, name = 'leviathan', commands = {
    ...
    { texture = nil, ptr = nil, action = nil, command = 'tail whip',        target = '<stpc>',  ranks = 1 },
    { texture = nil, ptr = nil, action = nil, command = 'spinning dive',    target = '<stpc>',  ranks = 1 },
    { texture = nil, ptr = nil, action = nil, command = 'grand fall',       target = '<stpc>',  ranks = 1 },
