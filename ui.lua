...
function ui:MainBar(ctrlDown, altDown, shiftDown, key)
  local buttons;
  if (ctrlDown) then
...
function ui:PetBar(ctrlDown, altDown, shiftDown, key)
  ...
  for i, button in ipairs(buttons or {}) do
    ...
    if (not ctrlDown and not altDown and not shiftDown and i == key) then
